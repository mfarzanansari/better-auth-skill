...
Internationalization plugin for translating error messages
  ...
  <Step>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="persist-install" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn add @better-auth/i18n
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun add @better-auth/i18n
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
  </Step>
...
Header-Based Detection [#header-based-detection]
...
Cookie-Based Detection [#cookie-based-detection]
...
Session-Based Detection [#session-based-detection]
...
Custom Detection Callback [#custom-detection-callback]
...
userLocaleField [#userlocalefield]
